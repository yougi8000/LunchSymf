...
class User implements UserInterface
{
    ...
    /**
     * @Assert\EqualTo(propertyPath="email", message="Vos adresses mails ne sont pas identiques !")
     */
    ...
    public function getNolove(): ?string
    {
        return $this->nolove;
    }

    public function setNolove(?string $nolove): self
    {
        $this->nolove = $nolove;
